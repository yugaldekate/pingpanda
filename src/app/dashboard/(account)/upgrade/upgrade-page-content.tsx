                ...
                <Card className="border-2 border-brand-700">
                    ...
                    <div>
                        <p className="text-2xl font-semibold">
                            ...
                            <span className="font-bold text-brand-700 text-3xl">{usageData?.eventsLimit.toLocaleString() || 100}</span>
                        </p>
                ...
                <Card>
                    ...
                    <div>
                        <p className="text-2xl font-semibold">
                            ...
                            <span className="font-bold text-brand-700 text-3xl">{usageData?.categoriesLimit.toLocaleString() || 10}</span>
                        </p>
            ...
            <p className="text-sm text-gray-500">
                ...
                {plan !== "PRO" ? (
                    <span
                        ...
                        className="inline cursor-pointer underline text-brand-700"
                    >
                        {" "}
